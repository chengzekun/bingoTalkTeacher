...
@interface BTStockView()<UITableViewDelegate,UITableViewDataSource,UIScrollViewDelegate>{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    BTStockViewCell* cell = (BTStockViewCell*)[tableView dequeueReusableCellWithIdentifier:CellID];
    ...
    [cell setRightContentTapBlock:^(BTStockViewCell* cell){
...
- (void)linkAgeScrollView:(UIScrollView*)sender{
    ...
    for (BTStockViewCell* cell in visibleCells) {
...
- (UITableView*)stockTableView{
    ...
    [_stockTableView registerClass:[BTStockViewCell class] forCellReuseIdentifier:CellID];
